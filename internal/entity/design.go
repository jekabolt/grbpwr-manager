...
//  3. ЛИЗА ХЕНДЛЕРА (store/design.HandlerLease) — она обязана ПЕРЕЖИВАТЬ пункт 2, иначе строку
...
//     бы с проводом молча в день, когда потолок появится у соседней.
//
...
// хендлера (store/design.HandlerLease) не могла её спросить через границу пакетов и была выведена
