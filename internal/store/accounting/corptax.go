...
// second call for the same period is a no-op (returns the existing accrual) — to re-accrue after more
// postings, reverse the prior entry first. Returns the CT accrued and whether it was already posted. A
// loss period (profit ≤ 0) posts nothing.
