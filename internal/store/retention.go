...
// Retention returns an object implementing Retention interface
func (ms *MYSQLStore) Retention() dependency.Retention {
...
func (rs *retentionStore) GetEntryProducts(ctx context.Context, from, to time.Time, limit int) ([]entity.EntryProductMetric, error) {
	...
	result, err := QueryListNamed[entity.EntryProductMetric](ctx, rs.DB(), query, map[string]any{
...
func (rs *retentionStore) GetRevenuePareto(ctx context.Context, from, to time.Time, limit int) ([]entity.RevenueParetoRow, error) {
	...
	result, err := QueryListNamed[entity.RevenueParetoRow](ctx, rs.DB(), query, map[string]any{
		"baseCurrency": baseCurrency,
		"from":         from,
		"to":           to,
		"limit":        limit,
...
func (rs *retentionStore) GetCustomerSpendingCurve(ctx context.Context, from, to time.Time) ([]entity.SpendingCurvePoint, error) {
	...
	result, err := QueryListNamed[entity.SpendingCurvePoint](ctx, rs.DB(), query, map[string]any{
		"baseCurrency": baseCurrency,
		"from":         from,
		"to":           to,
	})
...
func (rs *retentionStore) GetCategoryLoyalty(ctx context.Context, from, to time.Time) ([]entity.CategoryLoyaltyRow, error) {
	...
	result, err := QueryListNamed[entity.CategoryLoyaltyRow](ctx, rs.DB(), query, map[string]any{
		"baseCurrency": baseCurrency,
		"from":         from,
		"to":           to,
	})
