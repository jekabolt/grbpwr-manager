...
// WriteStore implements dependency.BQCacheStoreWriter.
...
func (s *WriteStore) DeleteBQFunnelAnalysisByDateRange(ctx context.Context, startDate, endDate time.Time) error {
...
func (s *WriteStore) InsertBQFunnelAnalysisBatch(ctx context.Context, rows []entity.DailyFunnel) error {
	if len(rows) == 0 {
		return nil
	}
	args := funnelAnalysisArgs(rows)
	if err := storeutil.BulkInsertRows(ctx, s.DB, "bq_funnel_analysis", funnelAnalysisCols, args); err != nil {
		return fmt.Errorf("insert bq funnel analysis batch: %w", err)
	}
	return nil
}

func (s *WriteStore) SaveBQFunnelAnalysis(ctx context.Context, rows []entity.DailyFunnel) error {
	if len(rows) == 0 {
		return nil
	}
	args := funnelAnalysisArgs(rows)
	if err := storeutil.BulkReplaceByDate(ctx, s.DB, "bq_funnel_analysis", funnelAnalysisCols, args); err != nil {
...
func (s *WriteStore) SaveBQOOSImpact(ctx context.Context, rows []entity.OOSImpactMetric) error {
	...
	if err := storeutil.BulkReplaceByDate(ctx, s.DB, "bq_oos_impact", cols, args); err != nil {
		return fmt.Errorf("save bq oos impact: %w", err)
	}
	return nil
}

func (s *WriteStore) SaveBQPaymentFailures(ctx context.Context, rows []entity.PaymentFailureMetric) error {
	if len(rows) == 0 {
		return nil
	}
	...
	if err := storeutil.BulkReplaceByDate(ctx, s.DB, "bq_payment_failures", cols, args); err != nil {
...
func (s *WriteStore) SaveBQWebVitals(ctx context.Context, rows []entity.WebVitalMetric) error {
	...
	if err := storeutil.BulkReplaceByDate(ctx, s.DB, "bq_web_vitals", cols, args); err != nil {
		return fmt.Errorf("save bq web vitals: %w", err)
	}
	return nil
}

func (s *WriteStore) SaveBQUserJourneys(ctx context.Context, rows []entity.UserJourneyMetric) error {
	if len(rows) == 0 {
		return nil
	}
	...
	if err := storeutil.BulkReplaceByDate(ctx, s.DB, "bq_user_journeys", cols, args); err != nil {
		return fmt.Errorf("save bq user journeys: %w", err)
	}
	return nil
}

func (s *WriteStore) SaveBQSessionDuration(ctx context.Context, rows []entity.SessionDurationMetric) error {
	if len(rows) == 0 {
		return nil
	}
	...
	if err := storeutil.BulkReplaceByDate(ctx, s.DB, "bq_session_duration", cols, args); err != nil {
		return fmt.Errorf("save bq session duration: %w", err)
	}
	return nil
}

func (s *WriteStore) SaveBQSizeIntent(ctx context.Context, rows []bq.SizeIntentRow) error {
	if len(rows) == 0 {
		return nil
	}
	...
	if err := storeutil.BulkReplaceByDate(ctx, s.DB, "bq_size_intent", cols, args); err != nil {
		return fmt.Errorf("save bq size intent: %w", err)
	}
	return nil
}

func (s *WriteStore) SaveBQDeviceFunnel(ctx context.Context, rows []entity.DeviceFunnelMetric) error {
	if len(rows) == 0 {
		return nil
	}
	...
	if err := storeutil.BulkReplaceByDate(ctx, s.DB, "bq_device_funnel", cols, args); err != nil {
		return fmt.Errorf("save bq device funnel: %w", err)
	}
	return nil
}

func (s *WriteStore) SaveBQProductEngagement(ctx context.Context, rows []entity.ProductEngagementMetric) error {
	if len(rows) == 0 {
		return nil
	}
	...
	if err := storeutil.BulkUpsertByDate(ctx, s.DB, "bq_product_engagement", cols, keyCols, args); err != nil {
		return fmt.Errorf("save bq product engagement: %w", err)
	}
	return nil
}

func (s *WriteStore) SaveBQFormErrors(ctx context.Context, rows []entity.FormErrorMetric) error {
	if len(rows) == 0 {
		return nil
	}
	...
	if err := storeutil.BulkReplaceByDate(ctx, s.DB, "bq_form_errors", cols, args); err != nil {
		return fmt.Errorf("save bq form errors: %w", err)
	}
	return nil
}

func (s *WriteStore) SaveBQExceptions(ctx context.Context, rows []entity.ExceptionMetric) error {
	if len(rows) == 0 {
		return nil
	}
	...
	args := make([][]any, 0, len(rows))
	for _, r := range rows {
		path := storeutil.TruncatePagePath(r.PagePath)
		hash := fmt.Sprintf("%x", md5.Sum([]byte(path+"\x00"+r.Description)))
		args = append(args, []any{
			r.Date.Format("2006-01-02"), path, r.ExceptionCount, r.Description, hash,
		})
	}
	if err := storeutil.BulkReplaceByDate(ctx, s.DB, "bq_exceptions", cols, args); err != nil {
		return fmt.Errorf("save bq exceptions: %w", err)
	}
	return nil
}

func (s *WriteStore) SaveBQNotFoundPages(ctx context.Context, rows []entity.NotFoundMetric) error {
	if len(rows) == 0 {
		return nil
	}
	...
	if err := storeutil.BulkReplaceByDate(ctx, s.DB, "bq_not_found_pages", cols, args); err != nil {
		return fmt.Errorf("save bq not found pages: %w", err)
	}
	return nil
}

func (s *WriteStore) SaveBQHeroFunnel(ctx context.Context, rows []entity.HeroFunnelMetric) error {
	if len(rows) == 0 {
		return nil
	}
	...
	if err := storeutil.BulkReplaceByDate(ctx, s.DB, "bq_hero_funnel", cols, args); err != nil {
		return fmt.Errorf("save bq hero funnel: %w", err)
	}
	return nil
}

func (s *WriteStore) SaveBQSizeConfidence(ctx context.Context, rows []entity.SizeConfidenceMetric) error {
	if len(rows) == 0 {
		return nil
	}
	...
	if err := storeutil.BulkReplaceByDate(ctx, s.DB, "bq_size_confidence", cols, args); err != nil {
		return fmt.Errorf("save bq size confidence: %w", err)
	}
	return nil
}

func (s *WriteStore) SaveBQPaymentRecovery(ctx context.Context, rows []entity.PaymentRecoveryMetric) error {
	if len(rows) == 0 {
		return nil
	}
	...
	if err := storeutil.BulkReplaceByDate(ctx, s.DB, "bq_payment_recovery", cols, args); err != nil {
		return fmt.Errorf("save bq payment recovery: %w", err)
	}
	return nil
}

func (s *WriteStore) SaveBQCheckoutTimings(ctx context.Context, rows []entity.CheckoutTimingMetric) error {
	if len(rows) == 0 {
		return nil
	}
	...
	if err := storeutil.BulkReplaceByDate(ctx, s.DB, "bq_checkout_timings", cols, args); err != nil {
		return fmt.Errorf("save bq checkout timings: %w", err)
	}
	return nil
}

func (s *WriteStore) SaveBQTimeOnPage(ctx context.Context, rows []entity.TimeOnPageRow) error {
	if len(rows) == 0 {
		return nil
	}
	...
	if err := storeutil.BulkReplaceByDate(ctx, s.DB, "bq_time_on_page", cols, args); err != nil {
		return fmt.Errorf("save bq time on page: %w", err)
	}
	return nil
}

func (s *WriteStore) SaveBQProductZoom(ctx context.Context, rows []entity.ProductZoomRow) error {
	if len(rows) == 0 {
		return nil
	}
	...
	if err := storeutil.BulkReplaceByDate(ctx, s.DB, "bq_product_zoom", cols, args); err != nil {
		return fmt.Errorf("save bq product zoom: %w", err)
	}
	return nil
}

func (s *WriteStore) SaveBQImageSwipes(ctx context.Context, rows []entity.ImageSwipeRow) error {
	if len(rows) == 0 {
		return nil
	}
	...
	if err := storeutil.BulkReplaceByDate(ctx, s.DB, "bq_image_swipes", cols, args); err != nil {
		return fmt.Errorf("save bq image swipes: %w", err)
	}
	return nil
}

func (s *WriteStore) SaveBQSizeGuideClicks(ctx context.Context, rows []entity.SizeGuideClickRow) error {
	if len(rows) == 0 {
		return nil
	}
	...
	if err := storeutil.BulkReplaceByDate(ctx, s.DB, "bq_size_guide_clicks", cols, args); err != nil {
		return fmt.Errorf("save bq size guide clicks: %w", err)
	}
	return nil
}

func (s *WriteStore) SaveBQDetailsExpansion(ctx context.Context, rows []entity.DetailsExpansionRow) error {
	if len(rows) == 0 {
		return nil
	}
	...
	if err := storeutil.BulkReplaceByDate(ctx, s.DB, "bq_details_expansion", cols, args); err != nil {
		return fmt.Errorf("save bq details expansion: %w", err)
	}
	return nil
}

func (s *WriteStore) SaveBQNotifyMeIntent(ctx context.Context, rows []entity.NotifyMeIntentRow) error {
	if len(rows) == 0 {
		return nil
	}
	...
	if err := storeutil.BulkReplaceByDate(ctx, s.DB, "bq_notify_me_intent", cols, args); err != nil {
		return fmt.Errorf("save bq notify me intent: %w", err)
	}
	return nil
}

func (s *WriteStore) SaveBQAddToCartRate(ctx context.Context, rows []entity.AddToCartRateRow) error {
	if len(rows) == 0 {
		return nil
	}
	...
	if err := storeutil.BulkReplaceByDate(ctx, s.DB, "bq_add_to_cart_rate", cols, args); err != nil {
		return fmt.Errorf("save bq add to cart rate: %w", err)
	}
	return nil
}

func (s *WriteStore) SaveBQBrowserBreakdown(ctx context.Context, rows []entity.BrowserBreakdownRow) error {
	if len(rows) == 0 {
		return nil
	}
	...
	if err := storeutil.BulkReplaceByDate(ctx, s.DB, "bq_browser_breakdown", cols, args); err != nil {
		return fmt.Errorf("save bq browser breakdown: %w", err)
	}
	return nil
}

func (s *WriteStore) SaveBQNewsletter(ctx context.Context, rows []entity.NewsletterMetricRow) error {
	if len(rows) == 0 {
		return nil
	}
	...
	if err := storeutil.BulkReplaceByDate(ctx, s.DB, "bq_newsletter", cols, args); err != nil {
		return fmt.Errorf("save bq newsletter: %w", err)
	}
	return nil
}

func (s *WriteStore) SaveBQAbandonedCart(ctx context.Context, rows []entity.AbandonedCartRow) error {
	if len(rows) == 0 {
		return nil
	}
...
func (s *WriteStore) SaveBQCampaignAttribution(ctx context.Context, rows []entity.CampaignAttributionRow) error {
	if len(rows) == 0 {
		return nil
	}
	...
	if err := storeutil.BulkReplaceByDate(ctx, s.DB, "bq_campaign_attribution", cols, args); err != nil {
