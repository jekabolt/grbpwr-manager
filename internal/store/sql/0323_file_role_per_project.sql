...
--
-- ПОРЯДОК ШАГОВ — ЧАСТЬ КОРРЕКТНОСТИ, А НЕ ОФОРМЛЕНИЕ. Он назван в шапке целиком, потому что
-- перестановка любых двух соседей даёт ЗЕЛЁНУЮ миграцию с потерянными данными:
--
