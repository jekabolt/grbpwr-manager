...
-- РАЗРЫВ ОПЕРАЦИЙ. Операция теряет одиннадцать колонок и получает семь; блок дефолтов карточки
...
--
-- ПОЧЕМУ ЭТИ ОДИННАДЦАТЬ УХОДЯТ, тремя разными группами — потому что лечатся они по-разному, и
-- через полгода это важнее списка:
--
