...
func TestGetStyleEconomics(t *testing.T) {
	...
	fit.EXPECT().ListFittings(mock.Anything, styleEconomicsFittingScan, 0, entity.Descending, 0, 0, 7).Return(nil, 3, nil)

	pr.EXPECT().ListProductionRuns(mock.Anything, productionRunPageSize, 0, entity.ProductionRunListFilter{TechCardId: 7}).Return([]entity.ProductionRun{
...
func TestGetStyleEconomicsNoCost(t *testing.T) {
	...
	fit.EXPECT().ListFittings(mock.Anything, styleEconomicsFittingScan, 0, entity.Descending, 0, 0, 9).Return(nil, 0, nil)
	pr.EXPECT().ListProductionRuns(mock.Anything, productionRunPageSize, 0, entity.ProductionRunListFilter{TechCardId: 9}).Return(nil, 0, nil)
