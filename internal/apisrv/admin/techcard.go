...
func (s *Server) UpdateTechCard(ctx context.Context, req *pb_admin.UpdateTechCardRequest) (*pb_admin.UpdateTechCardResponse, error) {
	...
	//   * раньше carryOmitted*, потому что dto.CarryOmittedCalloutGeometry сопоставляет выноски ПО
	//     НОМЕРУ, и выноска, пришедшая с нулём, подцепила бы геометрию ЛЕГАСИ-НУЛЯ — чужую мерку на
	//     чужой картинке, молча;
