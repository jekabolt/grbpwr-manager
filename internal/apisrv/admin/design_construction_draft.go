...
// словарь СТРОГО ШИРЕ прежнего: он содержит все одиннадцать канонических написаний члена энума и
// сверх них синонимы, ради которых он и заведён («m²», «sqm», «м», «metres», «pc», «шт», «кг»).
// Проба TestConstructionDraftUnitVocabularyIsTheColumnsOwn держит это включение.
//
