...
func TestFittingPatternsRoundTrip(t *testing.T) {
	in := &pb_common.FittingInsert{
		...
		Patterns: []*pb_common.FittingPattern{
			{SizeId: 4, Url: "https://cdn/tech-card-patterns/iter1.pdf", Filename: "iter1.pdf", SizeBytes: 99, Name: stringPointer(" бок v2 ")},
			{Url: "https://cdn/tech-card-patterns/iter2.dxf"}, // size unset, name absent
		},
	}
	...
	if len(ent.Patterns) != 2 || ent.Patterns[0].URL != "https://cdn/tech-card-patterns/iter1.pdf" ||
