...
// quantity terms.
//
// DELIBERATELY ABSENT — purpose / purpose_note / is_sample (0265), and kind / kind_note (0276) on
...
// unsorted and every pre-0276 line deliberately unclassified, so the operator's first sorting pass
